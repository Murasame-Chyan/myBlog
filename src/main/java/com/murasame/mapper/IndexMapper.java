...
public interface IndexMapper {
	...
	@Select("SELECT b.id, b.u_id, b.title, LEFT(b.content, 30) AS brief, b.created_at AS created_at, b.updated_at AS updated_at, u.nickname AS author, u.avatar AS author_avatar, b.t_id, b.read_count, b.like_count, COALESCE(c.comment_count, 0) AS comment_count" +
