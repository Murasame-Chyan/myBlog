...
public interface ArchiveMapper {
	...
	@Select("SELECT b.id, b.u_id, b.title, LEFT(b.content, 500) AS brief, b.created_at AS created_at, b.updated_at AS updated_at, u.nickname AS author, u.avatar AS author_avatar, b.t_id" +
	...
	@ResultMap("archiveResultMap")
	@Select("SELECT b.id, b.u_id, b.title, LEFT(b.content, 500) AS brief, b.created_at AS created_at, b.updated_at AS updated_at, u.nickname AS author, u.avatar AS author_avatar" +
